<template>
	<div class="py-6 px-3 flex flex-col justify-center">
		<h1
			class="text-primary text-bold text-2xl flex items-center justify-start"
		>
			<img src="/public/icon-bgrm.png" alt="" class="w-10" />Eaty Tracker
		</h1>

		<div class="my-8 flex justify-start w-full relative">
